...
class TestMsgSigntxSegwit(common.TrezorTest):
    ...
    def test_send_multisig_1(self):
        ...
        multisig = proto.MultisigRedeemScriptType(
            pubkeys=map(lambda n: proto.HDNodePathType(node=deserialize(n.xpub), address_n=[2, 0]), nodes),
            signatures=[b'', b'', b''],
            m=2,
        )
    ...
    def test_send_multisig_2(self):
        ...
        nodes = [self.client.get_public_node(self.client.expand_path("999'/1'/%d'" % index)) for index in range(1, 4)]
        multisig = proto.MultisigRedeemScriptType(
            pubkeys=map(lambda n: proto.HDNodePathType(node=deserialize(n.xpub), address_n=[2, 1]), nodes),
            signatures=[b'', b'', b''],
            m=2,
        )
    ...
    def test_send_multisig_3_change(self):
        ...
        multisig2 = proto.MultisigRedeemScriptType(
            pubkeys=map(lambda n: proto.HDNodePathType(node=deserialize(n.xpub), address_n=[1, 1]), nodes),
            signatures=[b'', b'', b''],
            m=2,
        )
    ...
    def test_send_multisig_4_change(self):
        ...
        multisig2 = proto.MultisigRedeemScriptType(
            pubkeys=map(lambda n: proto.HDNodePathType(node=deserialize(n.xpub), address_n=[1, 2]), nodes),
            signatures=[b'', b'', b''],
            m=2,
        )
